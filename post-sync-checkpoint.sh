...
SYNC_SEQ="${XLEDGRS_SYNC_LEDGER_SEQ:?missing XLEDGRS_SYNC_LEDGER_SEQ}"
SYNC_LEDGER_HASH="${XLEDGRS_SYNC_LEDGER_HASH:?missing XLEDGRS_SYNC_LEDGER_HASH}"
SYNC_ACCOUNT_HASH="${XLEDGRS_SYNC_ACCOUNT_HASH:?missing XLEDGRS_SYNC_ACCOUNT_HASH}"
DATA_DIR="${XLEDGRS_SYNC_DATA_DIR:?missing XLEDGRS_SYNC_DATA_DIR}"
