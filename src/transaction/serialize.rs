...
mod tests {
    ...
    fn test_field_canonical_ordering() {
        ...
        let mut fields = vec![
            Field { def: field::ACCOUNT,          value: FieldValue::AccountID([0u8; 20]) },
        ...
        assert_eq!(sorted_names, ["TRANSACTION_TYPE", "SEQUENCE", "FEE", "ACCOUNT"]);
    }
    ...
    fn make_payment_fields() -> Vec<Field> {
        vec![
            Field { def: field::TRANSACTION_TYPE, value: FieldValue::UInt16(0) }, // Payment
            Field { def: field::FLAGS,            value: FieldValue::UInt32(0) },
            Field { def: field::SEQUENCE,         value: FieldValue::UInt32(1) },
            Field { def: field::FEE,              value: FieldValue::Amount(Amount::Xrp(12)) },
            Field { def: field::SIGNING_PUB_KEY,  value: FieldValue::Blob(vec![0x02; 33]) },
            Field { def: field::ACCOUNT,          value: FieldValue::AccountID([1u8; 20]) },
            Field { def: field::DESTINATION,      value: FieldValue::AccountID([2u8; 20]) },
